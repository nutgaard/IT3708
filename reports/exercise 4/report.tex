...
\section{Part A}
	...
	\subsection{Inital implementation}
		...
		\subsubsection{Issues with implementation}
		...
		\subsubsection{Performance and issue mitigation}
			...
			either in a corner or against another epuck, and the saw a lot of ``fighting'' (alignment towards epuck instead of box). 
