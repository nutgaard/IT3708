...
This formed the basis for our second iteration where we converted the provided \textit{C} modules to Java, and introduced \texit{OOP} into these in order to fit into the overall architecture.
